...
"Wie spielt man Diplomacy?" => "Das Spielprinzip ist eigentlich selbsterkl&oauml;rend, jedenfalls nach einem Blick auf die kurze
	...
	<a href='https://diplomacy.db-cloud.de/regel.pdf' target='_blank'>Diplomacy-Regeln</a> durchzulesen.
...
"Ich m&ouml;chte tiefer in die Diplomacy-Regeln eintauchen" => "Schau dir dazu am Besten die offiziellen Spielregen. Hier sind sie als <a href='/regel.pdf' target='_blank'>pdf-Dokument</a> hinterlegt.",
...
"Wie kann ich Diplomacy's Website finanziell unterst&uuml;tzen?" => "Wenn du etwas Geld &uuml;brig hast und es an Diplomacy's Website spenden m&ouml;chtest, kannst du das gerne &uuml;ber Paypal machen:
	<div style='text-align:center'><form action='https://www.paypal.com/cgi-bin/webscr' method='post'><input type='hidden' name='cmd' value='_s-xclick'><input type='hidden' name='hosted_button_id' value='YWUCWYL2VQQNS'><input type='image' src='https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donateCC_LG.gif' border='0' name='submit' alt='Jetzt einfach, schnell und sicher online bezahlen â€“ mit PayPal.'><img alt='' border='0' src='https://www.paypalobjects.com/de_DE/i/scr/pixel.gif' width='1' height='1'></form></div>",
/*
