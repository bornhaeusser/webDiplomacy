...
<ul class="formlist">
	...
	<li class="formlistdesc">
		...
		<p style="text-align:center;">
			<img src="https://diplomacy.db-cloud.de/datc/maps/801-large.map-thumb" alt=" " title="An army holds in Naples" />
		</p>
	</li>
	...
	<li class="formlistdesc">
		...
		<p style="text-align:center;">
			<img src="https://diplomacy.db-cloud.de/datc/maps/802-large.map-thumb" alt=" " title="An army in Naples moves to Rome" />
		</p>
	</li>
	...
	<li class="formlistdesc">
		...
		<p style="text-align:center;">
			<img src="https://diplomacy.db-cloud.de/datc/maps/803-large.map-thumb" alt=" "
				title="Ein gelber Support move l&auml;sst die Armee in Venedig, die Armee in Rom besiegen." />
			<img src="https://diplomacy.db-cloud.de/datc/maps/804-large.map-thumb" alt=" "
	...
	<li class="formlistdesc">
		...
		<p style="text-align:center;">
			<img src="https://diplomacy.db-cloud.de/datc/maps/805-large.map-thumb" alt=" "
...
<li class="formlistdesc">
	...
	<p style="text-align:center;">
		<img src="https://diplomacy.db-cloud.de/datc/maps/806-large.map-thumb" alt=" "
		...
		<img src="https://diplomacy.db-cloud.de/datc/maps/807-large.map-thumb" alt=" "
...
<li class="formlistdesc">
	...
	<p style="text-align:center;">
		<img src="https://diplomacy.db-cloud.de/datc/maps/808-large.map-thumb" alt=" "
		...
		<img src="https://diplomacy.db-cloud.de/datc/maps/809-large.map-thumb" alt=" "
...
<li class="formlistdesc">
	...
	<p style="text-align:center;">
		...
		<img src="https://diplomacy.db-cloud.de/datc/maps/810-large.map-thumb" alt=" "
		...
		<img src="https://diplomacy.db-cloud.de/datc/maps/811-large.map-thumb" alt=" "
...
<li class="formlistdesc">
	...
	teilnehmen.
	<p style="text-align:center;">
		<img src="https://diplomacy.db-cloud.de/datc/maps/812-large.map-thumb" alt=" "
